                    ...
                    <form id="employeeForm">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <small class="text-muted">Departamento onde o colaborador trabalha</small>
                            </div>
                        </div>
...
@push('styles')
    <style>
        ...
        /* Adicione no final do bloco styles */
        .badge.bg-primary {
    ...
    <script>
        $(document).ready(function() {
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data) {
                                ...
                                const colorClass = colors[data] || 'dark';
            ...
            $(document).on('click', '.btn-edit', function() {
                ...
                $('#department').val(employeeDepartment);
